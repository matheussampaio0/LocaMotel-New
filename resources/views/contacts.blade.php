              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    ...
                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Endereço: <br> {{$funcionario->rua}}, {{$funcionario->numerocasa}} {{$funcionario->bairro}} - {{$funcionario->cidade}} {{$funcionario->estado}}</li>
